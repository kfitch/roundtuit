...
// configuration step. It creates a namespace called `roundtuit`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        roundtuit::cmake::project_name,
        roundtuit::cmake::project_version));// version string, acquired
